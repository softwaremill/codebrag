...
describe("Notification service", function () {
    ...
    var notificationService, events;
    
    var updatesUrl = 'rest/updates';

    beforeEach(module('codebrag.notifications'));

    beforeEach(inject(function (_$httpBackend_, _$rootScope_, _notificationService_, _events_, _$timeout_) {
