...
EnvJasmine.loadGlobal(EnvJasmine.rootDir + "session/showOnDemoDirective.js");
...
EnvJasmine.loadGlobal(EnvJasmine.rootDir + "commits/commitListMixins.js");
...
EnvJasmine.loadGlobal(EnvJasmine.rootDir + "common/uniqueRequestsAwareHttpService.js");
