...
(function (angular) {
    ...
    var largeDiff = {"commit": {"id": "519b3365e4b0dff2992c9beb", "sha": "3a335098dd49ea0cf1f53dfaa563db02df780596", "message": "Frontend service for loading and updating notification counters\n", "authorName": "Krzysztof Ciesielski", "committerName": "Krzysztof Ciesielski", "date": "2013-05-14T11:42:30Z", "pendingReview": true}, "diff": [
        {"filename": "codebrag-ui/src/main/webapp/scripts/app.js", "status": "modified", "lines": [
            {"line": "@@ -8,23 +8,25 @@", "lineNumberOriginal": "...", "lineNumberChanged": "...", "lineType": "header"},
            {"line": " angular.module('codebrag.auth', []);", "lineNumberOriginal": "8", "lineNumberChanged": "8", "lineType": "not-changed"},
            {"line": " ", "lineNumberOriginal": "9", "lineNumberChanged": "9", "lineType": "not-changed"},
        ...
        {"filename": "codebrag-ui/src/test/unit/specs/notifications/notificationCountersService-spec.js", "status": "added", "lines": [
            {"line": "@@ -0,0 +1,89 @@", "lineNumberOriginal": "...", "lineNumberChanged": "...", "lineType": "header"},
            {"line": "+'use strict';", "lineNumberOriginal": "", "lineNumberChanged": "1", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "2", "lineType": "removed"},
            {"line": "+describe(&quot;CommitsListService&quot;, function () {", "lineNumberOriginal": "", "lineNumberChanged": "3", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "4", "lineType": "removed"},
            {"line": "+    var $httpBackend;", "lineNumberOriginal": "", "lineNumberChanged": "5", "lineType": "removed"},
            {"line": "+    var rootScope;", "lineNumberOriginal": "", "lineNumberChanged": "6", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "7", "lineType": "removed"},
            {"line": "+    beforeEach(module('codebrag.notifications'));", "lineNumberOriginal": "", "lineNumberChanged": "8", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "9", "lineType": "removed"},
            {"line": "+    beforeEach(inject(function (_$httpBackend_, $rootScope) {", "lineNumberOriginal": "", "lineNumberChanged": "10", "lineType": "removed"},
            {"line": "+        $httpBackend = _$httpBackend_;", "lineNumberOriginal": "", "lineNumberChanged": "11", "lineType": "removed"},
            {"line": "+        rootScope = $rootScope;", "lineNumberOriginal": "", "lineNumberChanged": "12", "lineType": "removed"},
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "13", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "14", "lineType": "added"},
            {"line": "+    afterEach(inject(function (_$httpBackend_) {", "lineNumberOriginal": "", "lineNumberChanged": "15", "lineType": "added"},
            {"line": "+        _$httpBackend_.verifyNoOutstandingExpectation();", "lineNumberOriginal": "", "lineNumberChanged": "16", "lineType": "added"},
            ...
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "18", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "19", "lineType": "added"},
            {"line": "+    it('should call server only on first load', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "20", "lineType": "removed"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "21", "lineType": "removed"},
            {"line": "+        $httpBackend.expectGET('rest/notificationCounts').respond({pendingCommitCount: 0, followupCount: 0});", "lineNumberOriginal": "", "lineNumberChanged": "22", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "23", "lineType": "removed"},
            {"line": "+        // When", "lineNumberOriginal": "", "lineNumberChanged": "24", "lineType": "removed"},
            {"line": "+        notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "25", "lineType": "removed"},
            {"line": "+        $httpBackend.flush();", "lineNumberOriginal": "", "lineNumberChanged": "26", "lineType": "removed"},
            {"line": "+        notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "27", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "28", "lineType": "removed"},
            {"line": "+        // Then expected server url called only once", "lineNumberOriginal": "", "lineNumberChanged": "29", "lineType": "removed"},
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "30", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "31", "lineType": "added"},
            {"line": "+    it('should load counter values returned from server', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "32", "lineType": "added"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "33", "lineType": "added"},
            ...
            {"line": "+            });", "lineNumberOriginal": "", "lineNumberChanged": "39", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "40", "lineType": "added"},
            {"line": "+        // When", "lineNumberOriginal": "", "lineNumberChanged": "41", "lineType": "removed"},
            {"line": "+        var counters = notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "42", "lineType": "removed"},
            {"line": "+        $httpBackend.flush();", "lineNumberOriginal": "", "lineNumberChanged": "43", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "44", "lineType": "added"},
            {"line": "+        // Then", "lineNumberOriginal": "", "lineNumberChanged": "45", "lineType": "added"},
            {"line": "+        expect(counters.commits).toEqual(expectedCommitCount);", "lineNumberOriginal": "", "lineNumberChanged": "46", "lineType": "added"},
            ...
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "48", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "49", "lineType": "added"},
            {"line": "+    it('should correctly update counter values', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "50", "lineType": "removed"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "51", "lineType": "removed"},
            {"line": "+        var expectedCommitCount = 15;", "lineNumberOriginal": "", "lineNumberChanged": "52", "lineType": "removed"},
            {"line": "+        var expectedFollowupCount = 121;", "lineNumberOriginal": "", "lineNumberChanged": "53", "lineType": "removed"},
            {"line": "+        $httpBackend.expectGET('rest/notificationCounts').respond({", "lineNumberOriginal": "", "lineNumberChanged": "54", "lineType": "removed"},
            {"line": "+            pendingCommitCount: 1,", "lineNumberOriginal": "", "lineNumberChanged": "55", "lineType": "removed"},
            {"line": "+            followupCount: 2", "lineNumberOriginal": "", "lineNumberChanged": "56", "lineType": "removed"},
            {"line": "+        });", "lineNumberOriginal": "", "lineNumberChanged": "57", "lineType": "removed"},
            {"line": "+        var counters = notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "58", "lineType": "removed"},
            {"line": "+        $httpBackend.flush();", "lineNumberOriginal": "", "lineNumberChanged": "59", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "60", "lineType": "removed"},
            {"line": "+        // When", "lineNumberOriginal": "", "lineNumberChanged": "61", "lineType": "removed"},
            {"line": "+        notificationCountersService.updateCommits(expectedCommitCount);", "lineNumberOriginal": "", "lineNumberChanged": "62", "lineType": "removed"},
            {"line": "+        notificationCountersService.updateFollowups(expectedFollowupCount);", "lineNumberOriginal": "", "lineNumberChanged": "63", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "64", "lineType": "removed"},
            {"line": "+        // Then", "lineNumberOriginal": "", "lineNumberChanged": "65", "lineType": "removed"},
            {"line": "+        expect(counters.commits).toEqual(expectedCommitCount);", "lineNumberOriginal": "", "lineNumberChanged": "66", "lineType": "removed"},
            {"line": "+        expect(counters.followups).toEqual(expectedFollowupCount);", "lineNumberOriginal": "", "lineNumberChanged": "67", "lineType": "removed"},
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "68", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "69", "lineType": "removed"},
            {"line": "+    it('should correctly decrease counter values', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "70", "lineType": "removed"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "71", "lineType": "removed"},
            {"line": "+        var initialCommitCount = 15;", "lineNumberOriginal": "", "lineNumberChanged": "72", "lineType": "removed"},
            {"line": "+        var initialFollowupCount = 121;", "lineNumberOriginal": "", "lineNumberChanged": "73", "lineType": "removed"},
            {"line": "+        $httpBackend.expectGET('rest/notificationCounts').respond({", "lineNumberOriginal": "", "lineNumberChanged": "74", "lineType": "removed"},
            {"line": "+            pendingCommitCount: initialCommitCount,", "lineNumberOriginal": "", "lineNumberChanged": "75", "lineType": "removed"},
            {"line": "+            followupCount: initialFollowupCount", "lineNumberOriginal": "", "lineNumberChanged": "76", "lineType": "removed"},
            {"line": "+        });", "lineNumberOriginal": "", "lineNumberChanged": "77", "lineType": "removed"},
            {"line": "+        var counters = notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "78", "lineType": "added"},
            {"line": "+        $httpBackend.flush();", "lineNumberOriginal": "", "lineNumberChanged": "79", "lineType": "added"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "80", "lineType": "added"},
            {"line": "+        // When", "lineNumberOriginal": "", "lineNumberChanged": "81", "lineType": "added"},
            ...
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "28", "lineType": "removed"},
            {"line": "+        // Then expected server url called only once", "lineNumberOriginal": "", "lineNumberChanged": "29", "lineType": "removed"},
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "30", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "31", "lineType": "removed"},
            {"line": "+    it('should load counter values returned from server', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "32", "lineType": "removed"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "33", "lineType": "removed"},
            {"line": "+        var expectedCommitCount = 15;", "lineNumberOriginal": "", "lineNumberChanged": "34", "lineType": "removed"},
            {"line": "+        var expectedFollowupCount = 121;", "lineNumberOriginal": "", "lineNumberChanged": "35", "lineType": "removed"},
            {"line": "+        $httpBackend.expectGET('rest/notificationCounts').respond({", "lineNumberOriginal": "", "lineNumberChanged": "36", "lineType": "removed"},
            {"line": "+                pendingCommitCount: expectedCommitCount,", "lineNumberOriginal": "", "lineNumberChanged": "37", "lineType": "removed"},
            {"line": "+                followupCount: expectedFollowupCount", "lineNumberOriginal": "", "lineNumberChanged": "38", "lineType": "removed"},
            {"line": "+            });", "lineNumberOriginal": "", "lineNumberChanged": "39", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "40", "lineType": "removed"},
            {"line": "+        // When", "lineNumberOriginal": "", "lineNumberChanged": "41", "lineType": "removed"},
            {"line": "+        var counters = notificationCountersService.counters();", "lineNumberOriginal": "", "lineNumberChanged": "42", "lineType": "removed"},
            {"line": "+        $httpBackend.flush();", "lineNumberOriginal": "", "lineNumberChanged": "43", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "44", "lineType": "removed"},
            {"line": "+        // Then", "lineNumberOriginal": "", "lineNumberChanged": "45", "lineType": "removed"},
            {"line": "+        expect(counters.commits).toEqual(expectedCommitCount);", "lineNumberOriginal": "", "lineNumberChanged": "46", "lineType": "removed"},
            {"line": "+        expect(counters.followups).toEqual(expectedFollowupCount);", "lineNumberOriginal": "", "lineNumberChanged": "47", "lineType": "removed"},
            {"line": "+    }));", "lineNumberOriginal": "", "lineNumberChanged": "48", "lineType": "removed"},
            {"line": "+", "lineNumberOriginal": "", "lineNumberChanged": "49", "lineType": "removed"},
            {"line": "+    it('should correctly update counter values', inject(function (notificationCountersService) {", "lineNumberOriginal": "", "lineNumberChanged": "50", "lineType": "added"},
            {"line": "+        // Given", "lineNumberOriginal": "", "lineNumberChanged": "51", "lineType": "added"},
            {"line": "+        var expectedCommitCount = 15;", "lineNumberOriginal": "", "lineNumberChanged": "52", "lineType": "added"},
            {"line": "+        var expectedFollowupCount = 121;", "lineNumberOriginal": "", "lineNumberChanged": "53", "lineType": "added"},
