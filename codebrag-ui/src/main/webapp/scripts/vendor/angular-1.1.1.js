 ...
 * @description
 *
 * Use this directive to auto-codebrag on application. Only
 ...
 *
 * `ngApp` is the easiest way to codebrag an application.
 *
 <doc:example>
   <doc:source>
    I can add: 1 + 2 =  {{ 1+2 }}
...
/**
 * @ngdoc function
 * @name angular.codebrag
 * @description
 * Use this function to manually start up angular application.
 *
 * See: {@link guide/codebrag Bootstrap}
 *
 ...
 *  before the template enters execution mode during codebrag.
 *
 * @element ANY
...
var styleDirective = valueFn({
  ...
  //but we will rebind on codebrag again.
  bindJQuery();
