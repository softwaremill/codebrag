...
import com.softwaremill.codebrag.dao.browsingcontext.SQLUserBrowsingContextDAO
...
trait Daos {
  ...
  lazy val userBrowsingContextDao = new SQLUserBrowsingContextDAO(sqlDatabase)
