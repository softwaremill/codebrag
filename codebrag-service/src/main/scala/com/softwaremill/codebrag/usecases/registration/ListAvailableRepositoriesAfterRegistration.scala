...
class ListAvailableRepositoriesAfterRegistration(repositoriesCache: RepositoriesCache, val invitationService: InvitationService) extends ValidateInvitationCode {
